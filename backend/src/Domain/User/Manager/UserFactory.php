...
use App\Domain\User\Messenger\Model\EmailNotification;
...
class UserFactory extends AbstractFactory
{
     ...
     */
    public function createUser(UserPOPO $userDTO): UserEntity
    {
    ...
    public function sendPasswordRecoverNotification(UserPOPO $userDTO): UserEntity
    {
        /** @var UserEntity $user */
        $user = $this->entityManager->getRepository(UserEntity::class)->findOneBy(["email" => $userDTO->getEmail()]);
        if(empty($user)) {
